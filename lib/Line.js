...
class Line extends GraphicalObject {
    ...
    draw(ctx) {
        ...
        let baseX2 = this.x2
        let baseY2 = this.y2;
        console.log(this.group.childToParent(baseX1, baseY1));
        console.log(this.group.childToParent(baseX2, baseY2));
        if (this.group !== null) {
            baseX1 = this.group.childToParent(this.x1, this.y1)[0];
            baseY1 = this.group.childToParent(this.x1, this.y1)[1];
            baseX2 = this.group.childToParent(this.x2, this.y2)[0];
            baseY2 = this.group.childToParent(this.x2, this.y2)[1];
        }

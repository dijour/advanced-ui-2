    ...
    draw(ctx) {
        ...
        if (!this.layout) {
            for (let child in this.children) {
                ...
                // if (this.children[child].width) {
                //     // objectStart = this.children[child].x;
                //     w = this.children[child].width;
                // }
                // else if (this.children[child].x1) {
                //     // objectStart = this.children[child].x1;
                //     w = this.children[child].x2 - this.children[child].x1;
                // }
                // else {
                    w = this.children[child].getBoundingBox().width;
                // }
                let altOffset;
                console.log(child)
                child == 0 ? altOffset = 0 : altOffset = this.offset;
                console.log(altOffset)
        ...
        if (this.layout) {
            for (let child in this.children) {
                ...
                // }
                // else {
                    h = this.children[child].getBoundingBox().height;
                // }
                let altOffset;
                console.log(child)
                child == 0 ? altOffset = 0 : altOffset = this.offset;
